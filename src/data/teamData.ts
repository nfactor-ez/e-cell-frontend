...
type DepartmentData = {
  [departmentName: string]: HeadInfo[];
};

type YearlyTeamData = {
  [year: string]: DepartmentData;
};
    ...
    Marketing: [
      {
        ...
        linkedin:
          "https://www.linkedin.com/in/krishna-vatsal-mishra-163638258/",
...
export const getAvailableYears = (): string[] => {
  return Object.keys(teamData).sort((a, b) => b.localeCompare(a)); // Sort descending
};
